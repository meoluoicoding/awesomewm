   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#343434", "#FFC23C"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#FFC23C"),
            arrow("#FFC23C", "#A66CFF"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#A66CFF"),
            arrow("#A66CFF", "#4B696D"),
            ...
            arrow("#4B696D", "#FA2FB5"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#FA2FB5"),
            arrow("#FA2FB5", "#FA2FB5"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#FA2FB5"),
            arrow("#FA2FB5", "#D1512D"),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#D1512D"),
            arrow("#D1512D", "alpha"),
            --]]
            s.mylayoutbox,
        },
