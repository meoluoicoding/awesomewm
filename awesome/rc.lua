...
globalkeys = my_table.join(
    ...
    -- Function keys
    awful.key({ }, "F12", function () awful.util.spawn( "subl" ) end,
        {description = "subl" , group = "function keys"}),
    ...
    awful.key({ modkey }, "F3", function () awful.util.spawn( "idea" ) end,
        {description = "idea" ,group = "function keys" }),

    awful.key({ modkey }, "F4", function () awful.util.spawn( "notepadqq" ) end,
        {description = "notepadqq" , group = "function keys" }),

    awful.key({ modkey }, "F5", function () awful.util.spawn( "onlyoffice-desktopeditors" ) end,
        {description = "onlyoffice-desktopeditors" , group = "function keys" }),
    ...
    awful.key({ modkey }, "F9", function () awful.util.spawn( "gimp" ) end,
    ...
    awful.key({ modkey }, "F11", function () awful.util.spawn( "kitty" ) end,
        {description = "kitty" , group = "function keys" }),
    ...
    -- super + shift + ...
    awful.key({ modkey, "Shift"   }, "Return", function() awful.util.spawn( "libreoffice" ) end),
